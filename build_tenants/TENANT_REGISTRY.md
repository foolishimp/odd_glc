...
| Tenant | Status | Scope |
| --- | --- | --- |
| `build_tenants/odd_glc/typescript/` | active | Route-1 read/query and policy interpretation over ABIogenesis `4.1.0-rc.13` public GTL/ABG surfaces. |
...
interpretation library over ABIogenesis `4.1.0-rc.13`.
