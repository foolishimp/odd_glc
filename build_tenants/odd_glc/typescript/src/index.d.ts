...
export declare const ODD_GLC_SOFTWARE_BUILD_FULL_DATA_MAPPER_GRAPH_FUNCTION_REF: string;
export declare const ODD_GLC_SOFTWARE_BUILD_SDLC_STAGE_PLAN: readonly OddGlcSoftwareBuildStagePlanEntry[];
export declare const ODD_GLC_SOFTWARE_BUILD_FULL_DATA_MAPPER_STAGE_PLAN: readonly OddGlcSoftwareBuildStagePlanEntry[];
