...
A=Path('/Users/jim/src/apps/abiogenesis');G=Path('/Users/jim/src/apps/odd_glc');repo=Path(sys.argv[1]).resolve();root=repo/'.ai-workspace/comments/codex/20260923_WIP_CHECKPOINT/successor-14';previous=root.parent/'successor-13'
...
def add(p,expect=None):
 ...
 assert not any(x in rel for x in ['/fresh-native-01/resources/','/fresh-native-01/opus-successor-01/caller/','/fresh-native-01/opus-successor-03/']),rel
