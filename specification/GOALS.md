...
`/Users/jim/src/apps/abiogenesis/release_snapshots/abiogenesis-typescript-tenant/4.5.0-rc.16/release-snapshot-manifest.json`
...
ABIogenesis `4.5.0-rc.16` is the substrate under test for this wave. If the
...
`4.5.0-rc.16`, consume ABG instruction assembly, requirement-proof
