...
`/Users/jim/src/apps/abiogenesis/release_snapshots/abiogenesis-typescript-tenant/4.5.0-rc.14/release-snapshot-manifest.json`
...
ABIogenesis `4.5.0-rc.14` is the substrate under test for this wave. If the
...
`4.5.0-rc.14`, consume ABG instruction assembly, requirement-proof
